 ...
 * @version 2.0 $Id: event.php 14357 2011-10-28 22:23:04Z teknocat $
 */
class Event {
	/**
	 ...
	 *
	 * @param EventObserver|string $observer Reference to the EventObserver object being attached or name of a class (for static calls)
	 * @return void
	 * @author Peter Epp
	 */
