...
config. FontColor		= '#d3dacb'
config. FontFace		= 'Verdana, Geneva, helvetica, sans-serif'
...
function tt_Show()
{
	...
	css.zIndex = Math.max((window.dd && dd.z) ? (dd.z + 2) : 0, 60010);
